...
function extractNumber(arg1) {
    let newCode = Number(arg1.replace(/GSX-/i, ``));
    return newCode;
}

console.log(extractNumber(`GSX-444`)); // returns 444
console.log(extractNumber(`GSX-9867990`)); // returns 9867990